// Small example application of a color buffer using sokol.
// As a starting point https://github.com/floooh/sokol-samples/blob/master/sapp/quad-sapp.c was used.
...
half_window_width: i32 : window_width / 2 
half_window_height: i32 : window_height / 2 

square_size: i32 : 150 
half_square_size: i32 : square_size / 2 
...
frame :: proc "c" () {
    ...
    x := half_window_width - half_square_size 
    y := half_window_height - half_square_size 
...
make_color_rgba8 :: proc(color: u32) -> u32 {
    ...
    when ODIN_ENDIAN == .Big {
        return u32(red | green | blue | alpha) 
    }
